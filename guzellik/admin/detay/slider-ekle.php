...
if($_GET["islem"]=='duzenle'){
    $guncelle = $db->query("select * from slider where id='{$_GET["id"]}'")->fetch(PDO::FETCH_ASSOC);
}
?>
                           ...
                           <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Slider Ekle</h3></div>
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="include/fonksiyonlar.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Linki</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="linki" value="<?=$guncelle["linki"]?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Açıklama</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" rows="5" name="aciklama"><?=$guncelle["aciklama"]?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                    <?php if($_GET["islem"]=='duzenle'){?>
                                                    <input type="hidden" name="link" value="../slider-ekle?islem=duzenle&id=<?=$guncelle["id"]?>">
                                                    <input type="hidden" name="id" value="<?=$guncelle["id"]?>">
                                                  <button type="submit" name="slider-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../slider-ekle">
                                                  <button type="submit" name="slider-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
