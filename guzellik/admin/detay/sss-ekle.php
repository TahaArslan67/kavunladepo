                           ...
                           <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">S.S.S Ekle</h3></div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                  ...
                                                  <button type="submit" name="sss-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../sss-ekle">
                                                  <button type="submit" name="sss-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
