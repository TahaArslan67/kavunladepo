                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                  ...
                                                  <button type="submit" name="haber-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../haber-ekle">
                                                  <button type="submit" name="haber-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
