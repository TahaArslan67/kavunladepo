...
if($_GET['sil']){
	$idd=$_GET['sil'];
	 ...
	 $resim_sorgu=$db->query("select * from urunler where id='$idd'")->fetch(PDO::FETCH_ASSOC);
	 unlink('../resimler/'.$resim_sorgu['resim']);
	$simdi=$db->query("delete from urunler where id='$idd'")->fetch(PDO::FETCH_ASSOC);
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                        <a href="urun-ekle?islem=duzenle&id=<?=$goster["id"]?>" class="btn btn-default waves-effect">Düzenle</a>
