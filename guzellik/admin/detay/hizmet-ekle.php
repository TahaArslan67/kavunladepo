...
if($_GET["islem"]=='duzenle'){
    $guncelle = $db->query("select * from hizmetler where id='{$_GET["id"]}'")->fetch(PDO::FETCH_ASSOC);
}
?>
                           ...
                           <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Hizmet Ekle</h3></div>
                                        ...
                                        <form class="form-horizontal" action="include/fonksiyonlar.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <?php }?>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="file" class="form-control" name="icon" placeholder="placeholder">
                                                </div>
                                            </div>
                                            <?php if($_GET["islem"]=='duzenle'){?>
                                             <div class="form-group">
                                                <label class="col-md-2 control-label">Şuan ki İcon</label>
                                                <div class="col-md-10">
                                                   <img src="../resimler/<?=$guncelle["icon"]?>" width="200">
                                                </div>
                                            </div>
                                            <?php }?>
...
<div id="queue"></div>
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                    <?php if($_GET["islem"]=='duzenle'){?>
                                                    <input type="hidden" name="link" value="../hizmet-ekle?islem=duzenle&id=<?=$guncelle["id"]?>">
                                                    <input type="hidden" name="id" value="<?=$guncelle["id"]?>">
                                                  <button type="submit" name="hizmet-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../hizmet-ekle">
                                                  <button type="submit" name="hizmet-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
