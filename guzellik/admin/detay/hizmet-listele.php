                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Hizmet Listele</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $cek = $db->query("select * from hizmetler order by id desc")->fetchAll(PDO::FETCH_ASSOC);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                        <a href="hizmet-ekle?islem=duzenle&id=<?=$goster["id"]?>" class="btn btn-default waves-effect">Düzenle</a>
