...
if(isset($_POST["menu-ekle"])){
    ...
    $ekle = $db->prepare("insert into  menu set sira=:sira,adi=:adi,url=:url,kategori=:kategori,acilir=:acilir,durum=:durum,sekme=:sekme");
    $simdi = $ekle->execute(array("sekme"=>$_POST["sekme"],"sira"=>$_POST["sira"],"adi"=>$_POST["adi"],"url"=>$_POST["url"],"acilir"=>$_POST["acilir"],"durum"=>$_POST["durum"],"kategori"=>$_POST["kategori"]));
      if($simdi){
        header('location:'.$_POST['link'].'?durum=Basarili');
    }
    else {
...
if(isset($_POST["menu-guncelle"])){
    ...
    $ekle = $db->prepare("update   menu set sekme=:sekme,sira=:sira,adi=:adi,url=:url,kategori=:kategori,acilir=:acilir,durum=:durum where id=:id");
    $simdi = $ekle->execute(array("sekme"=>$_POST["sekme"],"sira"=>$_POST["sira"],"adi"=>$_POST["adi"],"url"=>$_POST["url"],"acilir"=>$_POST["acilir"],"durum"=>$_POST["durum"],"kategori"=>$_POST["kategori"],"id"=>$_POST["id"]));
      if($simdi){
        header('location:'.$_POST['link'].'?durum=Basarili');
    }
    else {
...
$seo= seflink($_POST['site_title']);
	...
	$ekle  = $db->prepare("update ayarlar set header=:header,footer=:footer,renk2=:renk2,renk=:renk,footer_copyright=:footer_copyright,site_title=:site_title,site_description=:site_description,site_author=:site_author,site_meta=:site_meta,site_keyword=:site_keyword,logo=:logo,favicon=:favicon,footer_logo=:footer_logo where id=:id");
	
	$simdi = $ekle->execute(array("footer"=>$_POST["footer"],"header"=>$_POST["header"],"renk2"=>$_POST['renk2'],"renk"=>$_POST['renk'],"footer_copyright"=>$_POST['footer_copyright'],"site_title"=>$_POST['site_title'],"site_meta"=>$_POST['site_meta'],"site_description"=>$_POST['site_description'],"site_author"=>$_POST['site_author'],"site_keyword"=>$_POST['site_keyword'],"logo"=>$logo,"footer_logo"=>$footer_logo,"favicon"=>$favicon,"id"=>1));
